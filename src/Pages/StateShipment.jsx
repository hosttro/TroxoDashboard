...
const StateShipment = () => {
  ...
  let [statistics, setStatistics] = useState({   localShipmentsCount: 0,
    internationalShipmentsCount: 0});

  let getStatics = async()=>{
    await axios.get(`https://troxo.runasp.net/api/statistics/user`, {
      ...
      <div className="w-full max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 bg-white p-6 gap-4 mb-8">
          <StatCardAdmin
            ...
            value={statistics.localShipmentsCount || "0"}
            change="5.39%"
            period="فترة التغيير"
          ...
          <StatCardAdmin
            ...
            value={statistics.internationalShipmentsCount|| "0"}
            change="+5%"
